...
final class PersistencyMeneger {
  
  // Здесь вы объявляете частную собственность для хранения данных альбома. Массив изменяемый, поэтому вы можете легко добавлять и удалять альбомы.
